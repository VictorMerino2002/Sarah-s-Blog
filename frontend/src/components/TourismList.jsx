...
import { deleteMagazine } from "../api/tourismApi"
import { PDFThumbnail } from "../components/PDFThumbnail"
import "../components/style/MagazineList.css"

export const TourismList = ({magazines, editor}) => {
    ...
    return (
        ...
        {magazines.map(magazine => (
            <div className="Magazine" key={magazine.id}>
                ...
                <PDFThumbnail key={magazine.id} id={magazine.id} title={magazine.title} date={magazine.date} base64={magazine.content} section={"tourism"}/>
            </div>
        ))}
        </div>
    )
